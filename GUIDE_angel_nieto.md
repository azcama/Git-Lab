# DOCUMENTATION - Ángel Nieto
# The commands used to create the branch.
The command I used to create the branch is "git checkout -b feature/angel-nieto".

# The process of staging and committing.
1. To create the file GUIDE_your_name.md, in the VS Code Explorer I clicked the 
"New File" button and named it "GUIDE_angel_nieto.md".

2. Now, to make a commit I went to the section called "Source Control", 
...
In my case, I kept the changes from develop, added my contribution, and committed the final version.